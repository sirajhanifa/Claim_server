...
const {getClaimCount, getStaffCount, getCreditedClaims, getPendingClaims, getAwaitingClaims, getInternalExternalClaims, getClaimTypeAmounts} = require('../controller/dashboardController');
